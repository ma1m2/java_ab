...
import ru.stqa.msl.mantis.model.MailMessage;
...
public class JamesHelper {
  ...
  public void creatUser(String name, String passwd){
    initTelnetSession();
  ...
  public void deletUser(String name, String passwd){
    initTelnetSession();
  ...
  private void initTelnetSession() {
    ...
    //Don't why it doesn't allow login at the first attempt
    readUntil("Login id:");
    write("");
    readUntil("Password:");
    write("");

    //Secont login attempt must be successful
    readUntil("Login id:");
    write(login);
    readUntil("Password:");
    write(password);
